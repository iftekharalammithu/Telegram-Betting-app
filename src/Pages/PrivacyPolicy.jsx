...
const PrivacyPolicy = () => {
  return (
    <div>
      <p>
        Our Privacy Policy Our Privacy Policy was posted on 13 Sep 2012 and last
        updated on 12 Sep 2021. This Privacy Policy describes Our policies and
        ...
        of information in accordance with this Privacy Policy. Interpretation
        ...
        access our Service or parts of our Service. Business, for the purpose of
        the CCPA (California Consumer Privacy Act), refers to the Company as the
        ...
        TermsFeed.com website. For the purpose of the GDPR, the Company is the
        Data Controller. Consumer, for the purpose of the CCPA (California
        ...
        that website among its many uses. Data Controller, for the purposes of
        the GDPR (General Data Protection Regulation), refers to the Company as
        the legal person which alone or jointly with others determines the
        purposes and means of the processing of Personal Data. Device means any
        device that can access the Service such as a computer, a cellphone or a
        digital tablet. Do Not Track (DNT) is a concept that has been promoted
        ...
        online activities across websites. Facebook Fan Page is a public profile
        named TermsFeed Facebook Fan Page specifically created by the Company on
        the Facebook social network, accessible from
        https://www.facebook.com/termsfeed Personal Data is any information that
        ...
        are considered Data Processors. Usage Data refers to data collected
        ...
        visit). Website refers to TermsFeed.com, accessible from
        https://www.termsfeed.com You means the individual accessing or using
        the Service, or the company, or other legal entity on behalf of which
        such individual is accessing or using the Service, as applicable. Under
        GDPR (General Data Protection Regulation), You can be referred to as the
        ...
        re-enter your preferences every time You use the Website. Tracking and
        Performance Cookies Type: Persistent Cookies Administered by:
        Third-Parties Purpose: These Cookies are used to track information about
        ...
        pages, features or new functionality of the Website to see how our users
        react to them. For more information about the cookies we use and your
        ...
        Service, for payment processing, to contact You. For business transfers:
        ...
        or that are under common control with Us. With business partners: We may
        ...
        security. Detailed Information on the Processing of Your Personal Data
        ...
        Privacy Policies. Analytics We may use third-party Service providers to
        ...
        secure handling of payment information. PayPal Their Privacy Policy can
        ...
        http://fastspring.com/privacy/ Usage, Performance and Miscellaneous
      </p>
    </div>
  );
};
