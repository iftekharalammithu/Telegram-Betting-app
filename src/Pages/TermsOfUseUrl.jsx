...
const TermsOfUseUrl = () => {
  return (
    <div>
      <p>
        Our Terms of Use Our Terms of Use were posted on 13 Sep 2012 and last
        updated on 12 Sep 2021. Please read these terms and conditions carefully
        ...
        "Our" in this Agreement) refers to TermsFeed.com website. Content refers
        ...
        regardless of the form of that content. Country refers to: Romania
        Device means any device that can access the Service such as a computer,
        a cellphone or a digital tablet. Feedback means feedback, innovations or
        suggestions sent by You regarding the attributes, performance or
        features of our Service. Products refer to the products or items offered
        for sale on the Service. Orders mean a request by You to purchase
        Products from Us. Promotions refer to contests, sweepstakes or other
        promotions offered through the Service. Service refers to the Website.
        Terms and Conditions (also referred as "Terms" or "Terms of Use") mean
        these Terms and Conditions that form the entire agreement between You
        and the Company regarding the use of the Service. Third-party Social
        ...
        displayed, included or made available by the Service. Website refers to
        TermsFeed.com, accessible from https://www.termsfeed.com You means the
        ...
        Privacy Policy carefully before using Our Service. Legal Advice
        Disclaimer for Our Products You understand that we offer legal
        contracts, policies or agreements ("Products"), as created and/or
        verified by attorneys or paralegals for sale through our Service. You
        ...
        attorney or paralegal or any Product as being better than another. We do
        not otherwise guarantee the legal accuracy or applicability of any
        Product for your legal needs. You will at all times look to any attorney
        or paralegal that you select for services as to any legal claims related
        to such services. You understand that it is your responsibility to
        ensure that the privacy policy or any other policies you create with us
        is complete, accurate, and meets your companies specific privacy needs.
        TermsFeed.com is not liable or responsible for any privacy policies or
        any other policies created using our services, and we give no
        representations or warranties, express or implied, that the privacy
        policies or any other policies created using our service are complete,
        accurate or free from errors or omissions. Placing Orders for Products
        By placing an Order for Products through the Service, You warrant that
        You are legally capable of entering into binding contracts. Your
        Information If You wish to place an Order for Products available on the
        Service, You may be asked to supply certain information relevant to Your
        Order including, without limitation, Your name, Your email, Your phone
        ...
        and warrant that: (i) You have the legal right to use any credit or
        debit card(s) or other payment method(s) in connection with any Order;
        ...
        reasons including but not limited to: Products availability Errors in
        the description or prices for Products Errors in Your Order We reserve
        the right to refuse or cancel Your Order if fraud or an unauthorized or
        illegal transaction is suspected. Your Order Cancellation Rights Any
        Products you purchase can only be returned or refunded in accordance
        with these Terms and Conditions. Refunds If you purchase a Product, and
        for some reason you decide that you would like a refund, you have 7 days
        to request a refund. If you request a refund within 7 days from the date
        of purchase, TermsFeed.com will give you a full refund of your purchase
        price. If you do not request a refund within the 7 day refund period,
        ...
        offerings of Products on the Service. The Products available on Our
        Service may be mispriced, described inaccurately, or unavailable, and We
        may experience delays in updating information regarding our Products on
        the Service and in Our advertising on other websites. We cannot and do
        ...
        inaccuracies, or omissions at any time without prior notice. Prices
        Policy The Company reserves the right to revise its prices at any time
        prior to accepting an Order. The prices quoted may be revised by the
        Company subsequent to accepting an Order in the event of any occurrence
        ...
        will have the right to cancel Your Order. Payments Payment can be made
        ...
        liable for any delay or non-delivery of Your Order. Promotions Any
        Promotions made available through the Service may be governed by rules
        ...
        Promotion rules will apply. User Accounts When You create an account
        ...
        rights. Impersonating any person or entity including the Company and its
        employees or representatives. Violating the privacy of any third person.
        False information and features. The Company reserves the right, but not
        the obligation, to, in its sole discretion, determine whether or not any
        Content is appropriate and complies with this Terms, refuse or remove
        this Content. The Company further reserves the right to make formatting
        and edits and change the manner any Content. The Company can also limit
        ...
        any content. Content Backups Although regular backups of Content are
        performed, the Company do not guarantee there will be no loss or
        ...
        copyright agent via email (see https://www.termsfeed.com/contact/) and
        ...
        and attorneys' fees) for misrepresenting that any Content is infringing
        Your copyright. DMCA Notice and DMCA Procedure for Copyright
        ...
        authorized to act on behalf of the owner of the copyright's interest. A
        ...
        email (see https://www.termsfeed.com/contact/). Upon receipt of a
        ...
        content from the Service. Intellectual Property The Service and its
        ...
        the Company and its licensors. The Service is protected by copyright,
        trademark, and other laws of both the Country and foreign countries. Our
        ...
        Your Feedback to Us You assign all rights, title and interest in any
        ...
        https://www.termsfeed.com/contact/ Legal compliance is now a breeze.
        Comply with the law with our agreements, policies, tools and cookie
        consent banners. Everything you need is included.
      </p>
    </div>
  );
};

export default TermsOfUseUrl;
